...
Adding nansense to a training loop is a few lines of code. This page covers raw PyTorch and PyTorch Lightning; the full argument reference lives in the [API reference](https://kongaskristjan.github.io/nansense/dev/api/index.md).

## Integrate with one prompt

Run this from your project with a coding agent (Claude Code, Cursor, …): it reads the docs and wires nansense into your training loop.
