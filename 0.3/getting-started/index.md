...
The fastest way to try NaNsense is to run one of the bundled examples — they download their datasets and pretrained networks automatically. To add NaNsense to your own training loop instead, paste [one prompt](https://kongaskristjan.github.io/nansense/0.3/integrate/index.md) into your coding agent, or install the library and follow the [Wiring guide](https://kongaskristjan.github.io/nansense/0.3/wiring/index.md) yourself.
...
A focused browser tab opens automatically at the boxed URL it prints (open it yourself if your environment has no browser); training pauses on the first batch. Drive it from the top bar — see the [UI guide](https://kongaskristjan.github.io/nansense/0.3/ui/index.md).
...
The [Wiring guide](https://kongaskristjan.github.io/nansense/0.3/wiring/index.md) walks through this for raw PyTorch and PyTorch Lightning, including time travel and distributed training — or let a coding agent do the wiring via [Integrate with one prompt](https://kongaskristjan.github.io/nansense/0.3/integrate/index.md).
